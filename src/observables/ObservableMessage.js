...
export class ObservableMessage {
  ...
  *deleteMessage() {
    console.log(
      `Deleting message ${this.id} in channel ${this.channelId} in tower ${this.towerId}`
    );
    try {
      ...
      console.log(
        `Deleted message ${this.id} in channel ${this.channelId} in tower ${this.towerId}`
      );
    } catch (error) {
  ...
  *editMessage(newMessageBody) {
    console.log(
      `Editing message ${this.id} in channel ${this.channelId} in tower ${this.towerId}`
    );
    try {
      ...
      console.log(
        `Edited message ${this.id} in channel ${this.channelId} in tower ${this.towerId}`
      );
    } catch (error) {
